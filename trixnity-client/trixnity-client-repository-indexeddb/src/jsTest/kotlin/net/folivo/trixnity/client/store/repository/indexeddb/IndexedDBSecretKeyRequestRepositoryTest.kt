...
class IndexedDBSecretKeyRequestRepositoryTest : ShouldSpec({
    timeout = 10_000
    lateinit var cut: IndexedDBSecretKeyRequestRepository
    lateinit var rtm: IndexedDBRepositoryTransactionManager

    beforeTest {
        cut = IndexedDBSecretKeyRequestRepository(createMatrixEventJson())
