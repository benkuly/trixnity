...
class IndexedDBDeviceKeysRepositoryTest : ShouldSpec({
    timeout = 10_000
    lateinit var cut: IndexedDBDeviceKeysRepository
    lateinit var rtm: IndexedDBRepositoryTransactionManager

    beforeTest {
        cut = IndexedDBDeviceKeysRepository(createMatrixEventJson())
