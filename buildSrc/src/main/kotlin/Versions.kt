object Versions {
    ...
    const val kotlinxCoroutines = "1.5.2" // https://github.com/Kotlin/kotlinx.coroutines/releases
    const val kotlinxSerializationJson = "1.3.0" // https://github.com/Kotlin/kotlinx.serialization/releases
    const val kotlinxDatetime = "0.2.1" // https://github.com/Kotlin/kotlinx-datetime/releases
    const val dokka = "1.5.30" // https://github.com/Kotlin/dokka/releases
    const val olm = "3.2.4" // https://gitlab.matrix.org/matrix-org/olm/-/releases
    const val jna = "5.9.0" // https://github.com/java-native-access/jna/releases
    const val ktor = "1.6.3" // https://github.com/ktorio/ktor/releases
