...
object Versions {
    const val trixnity = "3.11.0"

    val kotlinJvmTarget = JavaVersion.VERSION_11
    const val ksp = "1.9.20-Beta-1.0.13" // https://github.com/google/ksp/releases
    ...
    const val korlibs = "4.0.10" // https://github.com/korlibs/korge/releases
    ...
    const val arrow = "1.2.1" // https://github.com/arrow-kt/arrow/releases
    ...
    const val realm = "1.11.1" // https://github.com/realm/realm-kotlin/tags
    ...
    const val downloadGradlePlugin = "5.5.0" // https://github.com/michel-kraemer/gradle-download-task/releases
