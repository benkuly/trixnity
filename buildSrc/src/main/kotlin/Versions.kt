object Versions {
    const val kotlin = "1.6.20-RC" // https://github.com/JetBrains/kotlin/releases
    ...
    const val kotlinxAtomicfu = "0.17.1" // https://github.com/Kotlin/kotlinx.atomicfu/releases
    ...
    const val ktor = "2.0.0-eap-342" // https://github.com/ktorio/ktor/releases
    const val korlibs = "2.5.3" // https://github.com/korlibs/korge-next/releases
