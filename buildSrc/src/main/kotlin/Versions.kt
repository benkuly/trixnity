...
object Versions {
    ...
    const val ksp = "1.8.10-1.0.9" // https://github.com/google/ksp/releases
    ...
    const val ktor = "2.2.3" // https://github.com/ktorio/ktor/releases
    const val koin = "3.3.3" // https://github.com/InsertKoinIO/koin/tags
    const val korlibs = "3.4.0" // https://github.com/korlibs/korge/releases
    const val mocKmp = "1.12.0" // https://github.com/Kodein-Framework/MocKMP/releases
    ...
    const val realm = "1.6.1" // https://github.com/realm/realm-kotlin/tags
    const val downloadGradlePlugin = "5.3.1" // https://github.com/michel-kraemer/gradle-download-task/releases
