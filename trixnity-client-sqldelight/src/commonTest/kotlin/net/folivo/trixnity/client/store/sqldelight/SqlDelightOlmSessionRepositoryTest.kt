...
class SqlDelightOlmSessionRepositoryTest : ShouldSpec({
    ...
    should("save, get and delete") {
        ...
        val session1 = StoredOlmSession(key1, "session1", fromEpochMilliseconds(1234), pickle = "1")
        val session2 = StoredOlmSession(key2, "session2", fromEpochMilliseconds(1234), pickle = "2")
        val session3 = StoredOlmSession(key2, "session3", fromEpochMilliseconds(1234), pickle = "2")
