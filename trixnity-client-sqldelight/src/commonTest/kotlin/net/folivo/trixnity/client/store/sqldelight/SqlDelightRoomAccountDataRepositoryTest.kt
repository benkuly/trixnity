...
class SqlDelightRoomAccountDataRepositoryTest : ShouldSpec({
    ...
    should("save, get and delete") {
        ...
        val accountDataEvent1 = RoomAccountDataEvent(FullyReadEventContent(EventId("event1", "server")), roomId1)
        ...
        val accountDataEvent3 = accountDataEvent2.copy(roomId = roomId1)
