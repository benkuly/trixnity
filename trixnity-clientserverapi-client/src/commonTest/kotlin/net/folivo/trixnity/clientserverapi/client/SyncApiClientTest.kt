...
class SyncApiClientTest {
    ...
    fun shouldSyncOnce() = runTest {
        val matrixRestClient = MatrixClientServerApiClient(
            ...
            baseHttpClient = HttpClient(MockEngine { request ->
                assertEquals(
    ...
    fun shouldEmitEvents() = runTest {
        val response = SyncResponse(
            nextBatch = "nextBatch1",
            accountData = SyncResponse.GlobalAccountData(
                listOf(
            ...
            room = SyncResponse.Rooms(
                join = mapOf(
                    RoomId("room1", "Server") to SyncResponse.Rooms.JoinedRoom(
                        ...
                        state = SyncResponse.Rooms.State(
                            listOf(
                                Event.StateEvent(
                        ...
                        ephemeral = SyncResponse.Rooms.JoinedRoom.Ephemeral(emptyList()), //TODO
                        accountData = SyncResponse.Rooms.RoomAccountData(
                            listOf(
                ...
                leave = mapOf(
                    RoomId("room2", "Server") to SyncResponse.Rooms.LeftRoom(
                        timeline = SyncResponse.Rooms.Timeline(
                            listOf(
                                Event.MessageEvent(
                ...
                invite = mapOf(
                    RoomId("room3", "Server") to SyncResponse.Rooms.InvitedRoom(
                        SyncResponse.Rooms.InvitedRoom.InviteState(
                            listOf(
