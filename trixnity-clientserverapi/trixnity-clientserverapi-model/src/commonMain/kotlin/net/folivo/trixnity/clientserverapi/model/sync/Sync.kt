...
/**
 * @see <a href="https://spec.matrix.org/v1.3/client-server-api/#get_matrixclientv3sync">matrix spec</a>
 */
@Serializable
...
data class Sync(
    ...
    data class Response(
        ...
        @SerialName("device_unused_fallback_key_types") val deviceUnusedFallbackKeyTypes: List<KeyAlgorithm> = listOf(),
    ) {
        @Serializable
        data class Rooms(
