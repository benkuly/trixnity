...
class SyncResponseSerializerTest {
    ...
    fun supportCustomEvents() {
        ...
        val syncResponseString =
            $$"""{"next_batch":"next","rooms":{"join":{"!room":{"state":{"events":[{"content":{"foo":"foo"},"event_id":"$event","origin_server_ts":1234,"room_id":"!room","sender":"@sender:sender.org","state_key":"bar","type":"de.connect2x.custom"}]}}}}}"""
        assertEquals(
