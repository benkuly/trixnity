...
class OlmUtilityTest {
    ...
    @Test
    fun verifyEd25519Signing_shouldSign() = initTest {
    ...
    @Test
    fun verifyEd25519Signing_shouldFailOnBadSignature() = initTest {
        freeAfter(OlmAccount.create(), OlmUtility.create()) { account, utility ->
    ...
    @Test
    fun verifyEd25519Signing_shouldFailOnBadFingerprint() = initTest {
        freeAfter(OlmAccount.create(), OlmUtility.create()) { account, utility ->
            val messageSignature = account.sign(message)
